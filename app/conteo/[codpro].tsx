...
export default function ConteoScreen() {
  ...
  const [codproInput, setCodproInput] = useState(
    esNuevo
      ? normalizeCodpro(prefijo ?? "")
      : normalizeCodpro(codproParam ?? ""),
  );
  ...
  const codpro = esNuevo
    ? normalizeCodpro(codproInput)
    : normalizeCodpro(codproParam ?? "");
    ...
    return (
      <ModalScaffold title={titulo}>
        <View style={styles.center}>
          <ActivityIndicator color={InventarioColors.primary} size="large" />
        </View>
      </ModalScaffold>
    );
  }
      ...
      >
          ...
          <View style={styles.chips}>
            {familias.map((f) => (
              ...
              >
                <Text
                  style={
                    familiaId === f.id ? styles.chipOnText : styles.chipText
                  }
                >
                  {f.nombre}
                </Text>
          ...
          <View style={styles.ventasBox}>
            ...
            {stockContadoPrev != null ? (
              <Text style={styles.ventasSub}>
                ...
                {stockAjustado(stockContadoPrev, ventasDesdeConteo)}. Cuenta lo
                que hay en estante ahora.
              </Text>
            ) : (
              <Text style={styles.ventasSub}>
                Registra el físico actual en estante (ya descontando lo
                vendido).
              </Text>
            )}
          </View>
        ...
        >
          <Text style={styles.primaryText}>
            {guardando ? "Guardando..." : "Guardar y otro código"}
          </Text>
        </Pressable>
