...
const styles = StyleSheet.create({
  ...
  estadoOn: { backgroundColor: InventarioColors.jornadaBg, borderColor: InventarioColors.jornadaBorder },
  ...
  statNum: { color: InventarioColors.primary, fontWeight: '800', fontSize: 22 },
  ...
  filaCod: { color: InventarioColors.primary, fontWeight: '800' },
  filaQty: { color: InventarioColors.accent, fontWeight: '800', fontSize: 16 },
